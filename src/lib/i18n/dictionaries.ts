...
const id = {
  ...
  potsTitle: "Budgeting",
  newPot: "Baru",
  newPotTitle: "Anggaran baru",
  editPotTitle: "Edit anggaran",
  fieldPotName: "Nama anggaran",
  fieldPot: "Anggaran (opsional)",
  archivePot: "Arsipkan anggaran ini",
  potAllocateTitle: "Alokasikan",
  potAllocateDescription: "Isi jumlah buat anggaran yang mau ditambah — kosongkan yang lain.",
  ...
  potTransferTitle: "Pindah antar anggaran",
  potTransferSamePot: "Anggaran asal dan tujuan gak boleh sama.",
  fieldFromPot: "Dari anggaran",
  fieldToPot: "Ke anggaran",
  sendPotTransfer: "Pindahkan",
  emptyPotsTitle: "Belum ada anggaran",
  emptyPotsDescription: "Bikin anggaran buat mulai bagi-bagi uangmu sesuai tujuan, misalnya Tabungan atau Jajan.",
  needTwoPotsForTransfer: "Buat minimal 2 anggaran dulu buat bisa pindah-pindah saldo.",
...
const en: typeof id = {
  ...
  potsTitle: "Budgeting",
  newPot: "New",
  newPotTitle: "New budget",
  editPotTitle: "Edit budget",
  fieldPotName: "Budget name",
  fieldPot: "Budget (optional)",
  archivePot: "Archive this budget",
  potAllocateTitle: "Allocate",
  potAllocateDescription: "Fill in an amount for each budget you want to top up — leave the rest blank.",
  ...
  potTransferTitle: "Move between budgets",
  potTransferSamePot: "The source and destination budget can't be the same.",
  fieldFromPot: "From budget",
  fieldToPot: "To budget",
  sendPotTransfer: "Move",
  emptyPotsTitle: "No budgets yet",
  emptyPotsDescription: "Create a budget to start splitting your money by purpose, like Savings or Spending money.",
  needTwoPotsForTransfer: "Create at least 2 budgets first to move balance between them.",
